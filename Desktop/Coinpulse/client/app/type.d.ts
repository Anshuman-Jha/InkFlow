...
// fetch data by hitting api end point
// create columns. 
// match the column and styling layouts 
// Transfer Pattern to new DataSet and make it feel Consistent.
// Reading what api gives you and put that into use, we make types/constants(interfaces/types) based on that too.