...
import { CoinDetailsData, NextPageProps, OHLCData } from '@/app/type';
...
const Page = async ({ params }: NextPageProps) => {
    ...
    const platform = coinData.asset_platform_id ? coinData.detail_platforms?.[coinData.asset_platform_id]
        : null;
    // which network you are at i.e 3rd part of the split
