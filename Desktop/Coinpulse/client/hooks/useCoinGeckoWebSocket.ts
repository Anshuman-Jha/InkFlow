...
import { OHLCData, UseCoinGeckoWebSocketProps, UseCoinGeckoWebSocketReturn, WebSocketMessage } from "@/app/type";
import { useRef, useState, useEffect } from 'react';
import { ExtendedPriceData, Trade } from "@/app/type";
...
export const useCoinGeckoWebSocket = ({
    ...
    useEffect(() => {
        ...
        const handleMessage = (event: MessageEvent) => {
            ...
            if (msg.c === 'G2') {
                ...
                setTrades((prev) => [...prev, newTrade].slice(0, 7));
            ...
            if (msg.ch === 'G3') {
                ...
                const candle: OHLCData = [timestamp,
                    Number(msg.o ?? 0),
                    Number(msg.h ?? 0),
                    Number(msg.l ?? 0),
                    Number(msg.c ?? 0)
    ...
    // manages / subscribes to the connection we created
    useEffect(() => {
        ...
        const subscribed = (channel: string, data?: Record<string, unknown>) => {
